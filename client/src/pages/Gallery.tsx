...
export default function Gallery() {
  ...
  const works = [
    { id: 1, title: "Neon Dreams", category: "AI Art", image: "/images/hero-bg.jpg", author: "Member A" },
    { id: 2, title: "Mind Flow", category: "Graphic", image: "/images/mind-category.jpg", author: "Member B" },
    { id: 3, title: "Cyber City", category: "AI Art", image: "/images/ai-category.jpg", author: "Member C" },
    { id: 4, title: "Golden Pen", category: "Photo", image: "/images/writing-category.jpg", author: "Member D" },
    { id: 5, title: "Abstract Waves", category: "Graphic", image: "/images/columns-bg.jpg", author: "Member E" },
    { id: 6, title: "Prism Light", category: "AI Art", image: "/images/hero-bg.jpg", author: "Member F" },
  ];
    ...
    <div className="pt-24 pb-20">
      ...
      <section className="container mb-12">
        <div className="flex flex-wrap justify-center gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
          {["All", "AI Art", "Graphic", "Photo"].map((cat) => (
            <Button
              key={cat}
